...
1. **GET FREE SPIN ON BIGPAY77 🎰** - Shows free spin promotional information with inline buttons:
...
- `TELEGRAM_CHANNEL` (Optional) - Telegram channel URL (default: `https://t.me/bigpay77`)
- `FREE_SPIN_URL` (Optional) - Free spin promotion URL (default: `https://bigpay77.com/RFIBIGPAY77BOT9`)
- `FREE_CREDIT_URL` (Optional) - Free credit promotion URL (default: `https://bigpay77.com/RFIBIGPAY77BOT9`)
...
```bash
docker build -t bigpay77-bot .
docker run -d --env-file .env bigpay77-bot
```
...
2. Create volume: `fly volumes create bigpay77_bot_data --size 1 --region sin`
...
**Bigpay77 Promo Bot** - Making marketing simpler! 🚀
